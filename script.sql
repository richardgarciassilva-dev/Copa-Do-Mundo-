...
CREATE TABLE ARBITRO(
  ID INT PRIMARY KEY AUTO_INCREMENT,
  NOME VARCHAR (255) NOT NULL,https://github.com/richardgarciassilva-dev/Copa-Do-Mundo-.git
...
CREATE TABLE GOL_PARTIDA(
  ID INT PRIMARY KEY AUTO_INCREMENT,
  FK_PARTIDA INT NOT NULL,
  FOREIGN KEY (FKhttps://github.com/richardgarciassilva-dev/Copa-Do-Mundo-.git_PARTIDA) REFERENCES PARTIDA (ID),
  FK_JOGAhttps://github.com/richardgarciassilva-dev/Copa-Do-Mundo-.gitDOR INT NOT NULL,
  FOREIGN KEY (FK_JOGADOR) REFERENCES JOGADOR (ID),
  MINUTO CHAR (5) NOT NULL
);
...
ID INT PRIMARY KEY AUTO_INCREMENT,
FK_PARTIDA INT NOT NULL,
FOREIGN KEY (FK_PARTIDA) REFhttps://github.com/richardgarciassilva-dev/Copa-Do-Mundo-.gitERENCES PARTIDA (ID),
